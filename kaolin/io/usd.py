...
def import_mesh(file_path, scene_path=None, time=None):
    ...
    nametuple of:
        ...
        - **face_normals** (torch.LongTensor): of shape (num_faces, face_size, 3)
...
def import_meshes(file_path, scene_paths=None, heterogeneous_mesh_handler=None, times=None):
    ...
    list of nametuple of:
        - **vertices** (list of torch.Tensor): of shape (num_vertices, 3)
        - **faces** (list of torch.LongTensor): of shape (num_faces, face_size)
        - **uvs** (torch.Tensor): of shape (num_uvs, 2)
        - **face_uvs_idx** (torch.LongTensor): of shape (num_faces, face_size)
        - **face_normals** (list of torch.LongTensor): of shape (num_faces, face_size, 3)
        - **materials** (list of kaolin.io.materials.Material): A list of material properties
            (Not yet implemented)
